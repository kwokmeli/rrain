...
<?php if ( get_field('sub-menu_title_1') !== "" ) { ?>
  <div class="dgobag-icon"><img src=<?php the_field('sub-menu_image_1');?>></div>
  ...
  <br><br><div class="dgobag-ios"><img src="https://testing.hsl.washington.edu/tisha/rrain-test-site/img/download_ios.png" style="border: #ffffff 3px double"></div><img src="https://testing.hsl.washington.edu/tisha/rrain-test-site/img/download_android2.png"></div>
