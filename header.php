...
<html lang="en">
  <head>
    ...
    <?php if (is_front_page()) {
      ...
      <a href="ABOUT_URL"><img id="index-header-logo" src="<?php bloginfo('template_directory'); ?>/img/icon-outline.png"/></a><?php
    } else {
      ...
      <a href="ABOUT_URL"><img id="header-logo" src="<?php bloginfo('template_directory'); ?>/img/icon-outline.png"/></a>
      <?php
    } ?>
