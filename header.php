...
<html lang="en">
  <head>
    ...
    <?php if (is_front_page()) {
      ...
      <a href="/?page_id=59"><img id="index-header-logo" src="<?php bloginfo('template_directory'); ?>/img/icon-outline.png"/></a><?php
    } else {
      ...
      <a href="/?page_id=59"><img id="header-logo" src="<?php bloginfo('template_directory'); ?>/img/icon-outline.png"/></a>
      <?php
    } ?>
